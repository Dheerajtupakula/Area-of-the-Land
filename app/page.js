...
export default function Home() {
  ...
  return (
    <main className="relative flex flex-col justify-center items-center gap-3 ">
      ...
      {data.length > 2 && (
        <button
          className="inline-flex items-center justify-center mt-3 px-4 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 rounded-md bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:shadow-outline focus:outline-none"
          onClick={handleMap}
        >
          View Map
        </button>
